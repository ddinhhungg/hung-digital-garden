...
export const metadata = { title: "Thoughts — Hưng's Garden" };

export default function ThoughtsPage() {
  const posts = getAllPosts().filter(p => p.tag === 'thought');
    ...
    <>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '56px 48px 80px' }}>
        <div className="reveal" style={{ marginBottom: 40 }}>
          <div className="section-stamp" style={{ marginBottom: 8 }}>thoughts</div>
          ...
          <p style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--ink-muted)', lineHeight: 1.8, margin: 0 }}>
            Quan sát, cảm nhận, suy nghĩ vụn — không nhất thiết phải đúng, chỉ cần thật.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {posts.map((post, i) => (
            ...
            >
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 8 }}>
                  <span style={{
                    ...
                    border: '1.5px solid var(--ink-muted)', padding: '2px 6px', borderRadius: 2,
                    color: 'var(--ink-muted)',
                  }}>thought</span>
              ...
              <span style={{ fontFamily: 'var(--hand)', fontSize: 16, color: 'var(--ink-muted)', flexShrink: 0, marginTop: 4 }}>read →</span>
            </TransitionLink>
          ))}
